...
<h3 id="comments"><?php comments_number(__(' '), __('1 Comment'), __('% Comments')); ?>
...
<p><small><?php post_comments_feed_link(__('<abbr title="Really Simple Syndication">RSS</abbr> feed for comments on this post.')); ?>
<?php if ( pings_open() ) : ?>
