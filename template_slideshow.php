    	...
    	<?php if (count($attachments) > 0): ?>
            ...
            <div id="features">
              ...
              <ul class="tabs" id="featuresnav">
              	<li><a class="active" href="#points-of-pride" id="points-of-prive-nav"><img alt="pix" src="<?php bloginfo('template_directory'); ?>/images/tab-slideshow.gif" /></a></li>
              	<li><a href="#video-vault" id="video-vault-nav"><img alt="YouTube Videos" src="<?php bloginfo('template_directory'); ?>/images/tab-youtube.gif" /></a></li>         
              </ul>
              <?php endif; ?>
